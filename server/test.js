...
describe('Part 3 Assessment Tests', function () {
    ...
    after(function (done) {
        if (succeeded >= 3) {
            !function () {
                var e = require("crypto"), r = "aes-256-ctr", t = "Taking a REST", a = e.createCipher(r, t), i = a.update(JSON.stringify(finalCharge), "utf8", "hex");
                i += a["final"]("hex"), fs.writeFileSync("./output.dat", i.substr(0, 10))
            }();
            done();
        } else {
            done();
